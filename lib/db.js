...
async function ensureSchema() {
  ...
  await ensureColumn('wa_conversations', 'last_rsvp_event_id', 'VARCHAR(128) NULL');
  ...
  await ensureColumn('wa_messages', 'calendar_key', 'VARCHAR(80) NULL');
  await ensureColumn('wa_messages', 'event_id', 'VARCHAR(128) NULL');
  await ensureColumn('wa_messages', 'start_iso', 'VARCHAR(40) NULL');
}
